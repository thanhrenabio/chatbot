...
function sendMessage(senderId, message) {
  request({
    ...
    qs: {
      access_token: "EAAFcm6kGNXIBAI2154RrfuwVyjZAds5H1h2wgueHtXkqAcdSARmPDytC2MdQAIWGxCGVwRuZAMCKoOmaVjsjCCHn4Mo9mjlZAAJonWD4t68OEZB8cVAMlUsjTJvEgBaVWZCv3rPQvC7yQoZA7tcOztujxQ9bUEaxuJ9a9VvPWzMQZDZD",
    },
    method: 'POST',
    json: {
      recipient: {
